...
public class DESimage
{
    ...
    {	
        ...
        try
        {
        	//Enter the path of the image to be encrypted
            f1 = new File("C:\\Users\\Saurabh Singh\\Desktop\\Marvel.png");
            f2 = new File("C:\\Users\\Saurabh Singh\\Desktop\\Marvel.png");
        ...
        for(int i=0;i<height;i++)
        {
        	for(int j=0;j<width;j++)
        	{
		        ...
		        DES(pixel,key1);
		        System.out.println("Encrypted for "+count+"th pixel");count++;
		        for(int k=0;k<32;k++)
		        {
		        	if(k<8)
		        	{
		       ...
		       Color c2=new Color(r,g,b,a);
	            im2.setRGB(j,i, c2.getRGB());
		        ares=rres=gres=bres="";
        	}
        }
        //Enter the path of the 2 encrypted images
